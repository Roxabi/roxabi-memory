...
- T2: 10 — Create NatsSubscriber class skeleton
- T3: 11 — Implement run() with env config loading
- T4: 12 — Add subject configuration from env
- T5: 13 — Implement handle() with field mapping
- T6: 14 — Add unit tests for NatsSubscriber
- T7: 15 — Export NatsSubscriber from __init__.py
- T8: 16 — Create docker-compose.nats.yml fixture
- T9: 17 — Create integration test
